...
public class SQLHelper
{
        ...
        if (parameterMappings != null)
        {
            ...
            for (int i = 0; i < parameterMappings.size(); i++)
            {
                ...
                if (parameterMapping.getMode() != ParameterMode.OUT)
                {
                    ...
                    if (typeHandler == null) { throw new ExecutorException("There was no TypeHandler found for parameter " + propertyName + " of statement "
     ...
     */
    public static Long getCount(final String sql, final Connection connection, final MappedStatement mappedStatement, final Object parameterObject, final BoundSql boundSql)
            throws SQLException
    {
