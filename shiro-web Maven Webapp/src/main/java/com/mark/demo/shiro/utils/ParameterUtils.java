...
import com.mark.demo.shiro.constant.ApplicationConst;
...
public class ParameterUtils
{
    ...
    {
        EnumDescribable code = ClientConst.FAILURE;
        if (null != parameter)
        {
            ...
            if (null != dataLen)
            {
                if (validateClientDataLength(parameter.getDataLen(), parameter.getData()))
                {
                    ...
                    {
                        code = ClientConst.DESERROR;
                    }
                }
                else
                {
                    code = ClientConst.LENERROR;
                }
            }
            else
            {
    ...
    public static String getUserDes(String userKey, Integer dataLen)
    {
        ...
        if (null != dataLen && StringUtils.isNotBlank(userKey))
        {
            ...
            result = EncodeUtils.getXorString(stringBuffer.toString(), ApplicationConst.LANGUAGE_UT);
        }
        return result;
    }
    ...
    {
        return StringUtils.isNotBlank(param) && param.length() == ApplicationConst.UUID_SIZE;
    }
    ...
    public static String getStringValue(Map<String, String> data, String fieldName, Boolean isRequire) throws BusinessException
    {
        ...
        {
            if (isRequire) { throw new BusinessException(CommonConst.FAIL.code, fieldName + "不能为空"); }
            return null;
        }
        else
        {
    ...
    {
        /*
         * Map<String, String> param = Maps.newHashMap(); param.put("str",
         * "http://www.baidu.co,m"); String date = getDataFromMap(param);
         * System.out.println("date" + date);
         * // str:http0X00//www.baidu.co0XFFm
         * Map<String, String> map =
         * getMapFromData("str:http0X00//www.baidu.co0XFFm");
         * System.out.println(map.get("str")); // http://www.baidu.co,m
         */
